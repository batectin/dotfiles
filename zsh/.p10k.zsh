# Generated by Powerlevel10k configuration wizard on 2021-08-15 at 21:00 +08.
...
() {
  ...
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_CONTENT_EXPANSION='%B${P9K_CONTENT}'
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=213
  ...
  typeset -g POWERLEVEL9K_RAM_CONTENT_EXPANSION='%B${P9K_CONTENT}'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=30
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=247
